...
export enum ActionTypes {
  ...
  PATCH_PHS_ID = 'PATCH_PHS_ID',
  PATCH_PHS_ID_SUCCESS = 'PATCH_PHS_ID_SUCCESS',
  PATCH_CONSENT_CODE = 'PATCH_CONSENT_CODE',
  PATCH_CONSENT_CODE_SUCCESS = 'PATCH_CONSENT_CODE_SUCCESS',
  EXCEPTION = 'EXCEPTION',
}
