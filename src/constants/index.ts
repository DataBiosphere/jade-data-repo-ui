...
export enum ActionTypes {
  ...
  LINK_DUOS_DATASET = 'LINK_DUOS_DATASET',
  LINK_DUOS_DATASET_SUCCESS = 'LINK_DUOS_DATASET_SUCCESS',
  LINK_DUOS_DATASET_FAILURE = 'LINK_DUOS_DATASET_FAILURE',
  UNLINK_DUOS_DATASET = 'UNLINK_DUOS_DATASET',
  UNLINK_DUOS_DATASET_SUCCESS = 'UNLINK_DUOS_DATASET_SUCCESS',
  UNLINK_DUOS_DATASET_FAILURE = 'UNLINK_DUOS_DATASET_FAILURE',
  EXCEPTION = 'EXCEPTION',
}
