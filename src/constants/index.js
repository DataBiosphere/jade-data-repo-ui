...
export const ActionTypes = keyMirror({
  ...
  RESET_SNAPSHOT_EXPORT: undefined,
  RESET_SNAPSHOT_EXPORT_DATA: undefined,
  GET_DATASETS: undefined,
  GET_DATASETS_SUCCESS: undefined,
  GET_DATASET_BY_ID: undefined,
  GET_DATASET_BY_ID_START: undefined,
  ...
  ADD_DATASET_POLICY_MEMBER: undefined,
  ...
  GET_BILLING_PROFILE_BY_ID_EXCEPTION: undefined,
...
export const DATASET_INCLUDE_OPTIONS = {
  NONE: 'NONE',
  SCHEMA: 'SCHEMA',
...
export const SNAPSHOT_INCLUDE_OPTIONS = {
  NONE: 'NONE',
  SOURCES: 'SOURCES',
  TABLES: 'TABLES',
