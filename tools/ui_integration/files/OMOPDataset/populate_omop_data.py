...
def main():
    ...
    query_table_where_person_id_record_concepts(client, "measurement", 21)
    query_table_where_person_id_record_concepts(client, "visit_occurrence", 8)
    query_table_where_person_id_record_concepts(client, "device_exposure", 8)
    query_table_where_person_id_record_concepts(client, "observation", 27)
